...
本仓库是 PRD Sub-Harness v2.1。目标是通过总控 orchestrator 和多个子 harness，维护 AI-ready PRD package，并把结构化事实安全投射为 two-pass prototype runtime / renderer stage plan / Figma 原型。

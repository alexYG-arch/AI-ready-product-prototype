# Prototype Projection Harness v1.2 Update Notes

## What changed

v1.2 upgrades the standalone prototype harness with five major capabilities:
...
The runtime model is not generated in one opaque step. v1.2 uses:

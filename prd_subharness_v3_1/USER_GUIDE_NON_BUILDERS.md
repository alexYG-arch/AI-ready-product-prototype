...
v2.0 要求 `projection_sync_harness` 把 YAML 内容投影到完整 PRD.md 中；如果涉及原型，还会由 `prototype_projection_harness` 生成 runtime 和 Figma interaction map。

# PRD Sub-Harness v1.0

中文名：AI-ready PRD 子 Harness 架构 1.0  
版本：v1.0  
定位：把 v0.3 的单体 PRD mini harness 重构为 **总控 Orchestrator + 多个子 Harness**。  
适用：已有 PRD 迁移、AI-ready PRD 维护、自然语言变更、多文档协作、PRD.md 与 YAML 同步、需求质量检查、状态推理、指标埋点、发布计划和追踪矩阵。
